...
// EncryptionConfig holds resolved encryption keys for event log persistence.
...
// SetEncryptionConfig sets the global encryption config for event log writes/reads.
